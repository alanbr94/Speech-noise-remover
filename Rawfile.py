...
#Argumentos necessário para a execução do algoritmo: -input file_name
#Exempo de execução no prompt powersheell anaconda:  python ./Filtro_de_ruido.py --input Audio1.wav
...
def main():
    ...
    p.add_argument('--input', '-i', required=True) #Recebe o áudio como argumento
    ...
    args = p.parse_args()
    sound = AudioSegment.from_file(args.input)
    sound.export(args.input, format="wav")
